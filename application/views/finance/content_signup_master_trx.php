...
<div class="card">
	<div class="card-header">
		<h3 class="card-title">Master Data Transaksi</h3>
	</div>
	<div class="card-body">
		<h4>Filter Data</h4>
		<form method="get" action="<?= base_url('finance/signup/master?')?>">
			<div class="row">
				<div class="col-md-6">
					<div class="form-group row">
						<label class="col-sm-4 col-form-label">Program</label>
						<div class="col-sm-8">
							<select class="form-control js-example-basic-single" name="event" id="event" width="100%">
					...
					<div class="form-group row">
						...
						<div class="col-sm-8" id="div_batch">
							<select class="form-control js-example-basic-single" name="batch" id="batch" width="100%">
								<option value="all">All</option>
					...
					<div class="form-group row">
						...
						<div class="col-sm-8">
							<select class="form-control js-example-basic-single" name="sp" id="sp" width="100%">
								<option value="all">All</option>
								<?php 
					...
					<div class="form-group row">
						...
						<div class="col-sm-8">
							<select class="form-control js-example-basic-single" name="warrior" id="warrior" width="100%">
								<option value="all">All</option>
								<?php 
								foreach($list_warrior as $row) {
									if($row['id'] == $this->input->get('warrior')){
				...
				<div class="col-md-6">
					<div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <select class="form-control js-example-basic-single" name="branch" id="branch" width="100%">
                                <option value="all">All</option>
                                <?php 
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <select class="form-control js-example-basic-single" name="class" id="class" width="100%">
                                <option value="all">All</option>
                                <?php 
					...
					<div class="form-group row">
						...
						<div class="col-sm-8">
							<input type="text" name="date_start" id="date_start" class="form-control" value="<?= !empty($this->input->get('date_start'))?$this->input->get('date_start'):''?>">
						</div>
					</div>
					<div class="form-group row">
						<label class="col-sm-4 col-form-label">Date End</label>
						<div class="col-sm-8" id="div_date_end">
							<input type="text" name="date_end" id="date_end" class="form-control" value="<?= !empty($this->input->get('date_end'))?$this->input->get('date_end'):''?>">
						</div>
					</div>
				</div>
			</div>
...
<script>
	...
	$('#export').click(function(){
		...
		var url 	= "<?= base_url('finance/signup/export_data_trx?')?>"+query;
	...
	function init_batch(){
		...
		if(event != 'all'){
			$.ajax({
				url: "<?= base_url('finance/signup/json_get_batch_list')?>",
				type: "POST",
				dataType: "json",
				data:{'event': event},
	...
	function detail_trx(id){
		...
		$.ajax({
			url: "<?= base_url('finance/signup/json_master_get_detail_transaction')?>",
			type: "POST",
			dataType: "json",
			data:{'id': id},
			success:function(result){		
