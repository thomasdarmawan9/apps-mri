<div class="card">
  <div class="card-header">
    <h3 class="card-title">Income Transaction Data</h3>
  </div>
  <div class="card-body">

  
        <!--<a class="btn btn-primary float-right" id="showtambah"><i class="fa fa-plus"></i>&nbsp; Add Transaction</a>-->
    <a href="<?= base_url('finance/accountant/add_transaction_income/?baris=""') ?>"><button type="button" class="btn btn-primary float-right"><i class="fa fa-plus"></i> Add Transaction</button></a>
            ...
            <tr>
              ...
              <td nowrap='nowrap'>
               <?php
                ...
                <?php } else { ?>
                  <button type='button' id='detail_trx' class='btn btn-blue-grey' onclick='detail_trx("<?php echo $row->id_trans ?>")'><i class='fa fa-info'></i> DETAIL</button>
                  <a href=<?php echo base_url('finance/accountant/edit_income/' . $row->id_trans . '?' . http_build_query(array('id_trans' => $row->id_trans, 'id_bank' => $row->id_bank, 'id_divisi' => $row->id_divisi, 'id_indeks' => $row->id_indeks))) ?>>
...
<div class="modal fade" id="modal_tambah" data-backdrop="static" data-keyboard="false" role="dialog">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <form action="<?= base_url('finance/accountant/submit_form_income') ?>" method="post" id="form_data" class="form-horizontal" style="width:100%">
        <div class="modal-header">
          <h4 class="modal-title" id="myModalLabel">Form Income Transaction</h4>
          ...
          <div class="row">
            <div class="col-md-6">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-12">
                  <input name="receipt_number" id="receipt_number" class="form-control" type="text" placeholder="Receipt Number" required="" autocomplete="off">
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-12">
                  <input name="tgl_nota" id="tgl_nota" class="form-control datepicker" type="input" placeholder="Date (Nota)" required="" autocomplete="off">
                </div>
              </div>
            ...
            <div class="col-md-6">
             ...
             <div class="form-group">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-12">
                  <input name="jumlah" id="jumlah" class="form-control" onkeyup="cek_indeks();" type="text" placeholder="Qty" required="" autocomplete="off">
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-12">
                  <input name="harga" id="harga" class="form-control" onkeyup="cek_indeks();" type="text" placeholder="Price" required="" autocomplete="off">
                </div>
              </div>
              ...
              <div class="form-group" hidden="">
                ...
                <div class="col-sm-12">
                  <input name="expense" id="expense" class="form-control" readonly="" type="text" placeholder="Pengeluaran" value="0" required="">
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-12">
                  <input name="income" id="income" class="form-control" readonly="" type="text" value="" placeholder="Income" required="">
                </div>
              </div>
          ...
          <div class="card">
            <div class="card-body">
               <div class="form-group row">
                ...
                <div class="col-sm-8">
                  <input type="text" class="form-control" id="det_receipt_number" value="" readonly="">
                </div>
              </div>
              <div class="form-group row">
...
<script type="text/javascript">
    ...
    $.ajax({
      ...
      success: function(result) {
        $.each(result, function(index, item) {
          ...
          $('#id_indeks').append('<option value="' + item.id_indeks + '">'+ item.no_indeks+ ' - ' + item.nama_indeks + '</option>');
        });
  ...
  function detail_trx(id) {
    ...
    $.ajax({
      url: "<?= base_url('finance/accountant/json_get_income_transaction') ?>",
      type: "POST",
      dataType: "json",
      data: {
        'id': id
      ...
      success: function(result) {
        $('#det_receipt_number').val(result.receipt_number);
  ...
  function hapus(id) {
    if (id != '') {
      swal({
        title: 'Konfirmasi',
        text: "Data Income Cash Akan Dihapus, Lanjutkan?",
        type: 'warning',
