		...
		<div class="modal-content">
			<form action="<?= base_url('finance/signup/submit_form')?>" method="post" id="form_data" class="form-horizontal" style="width:100%">
				...
				<div class="modal-body">
					...
					<div class="form-group row">
						<label class="col-form-label col-sm-4">Pilih Event</label>
						<div class="col-sm-8">
					...
					<div class="form-group row">
						...
						<div class="col-sm-8">
							<input name="batch_label" id="batch_label" class="form-control" required="" type="text" placeholder="Label Batch">
						</div>
					</div>
					<div class="form-group row">
						<label class="col-form-label col-sm-4">Tanggal</label>
						<div class="col-sm-8">
							<input name="event_date" id="event_date" class="form-control datepicker" required="" type="text" placeholder="Tanggal Event">
						</div>
					</div>
