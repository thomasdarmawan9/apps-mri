...
<div class="card">
    ...
    <div class="card-body">
        ...
        <form method="post" action="<?= base_url(); ?>finance/accountant/add_row_income_finance">
            ...
            <div class="row">
                ...
                <?php if (empty($_GET['baris'])) { ?>
                    <input type="text" name="redirect" style="display:none;" value="<?= base_url(); ?>finance/accountant/add_transaction_income/?">
...
<?php if (!empty($_GET['baris'])) { ?>
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <form action="<?= base_url(); ?>finance/accountant/submit_form_income" method="post">
                ...
                <table class="table table-striped w-100" id="tbl_posts">
                    ...
                    <tbody id="tbl_posts_body">
                        ...
                        <tr id="rec-0">
                            ...
                            <td><input type="text" name="income0" id="income0" class="form-control" required style="width: 160px"></td>
...
<div style="display:none;">
    <table id="sample_table">
        <tr id="">
            ...
            <td><input type="text" name="" id="" class="form-control income" required style="width: 160px"></td>
            <!--<td hidden>-->
...
<script type="text/javascript">
    ...
    jQuery(document).delegate('a.add-record', 'click', function(e) {
        ...
        element.find('.income').attr('name', 'income' + size);
        ...
        $('#harga' + size).keyup(function() {
            ...
            if (!isNaN(result)) {
                document.getElementById('income' + size).value = total;
            } else {
                $('#income' + size).empty();
            }
    ...
    // START OF CALCULATE 
     ...
     function cek_indeks() {
        ...
        var secondNumber = txtSecondNumberValue.replace(/,/g, '');
        var firstNumber = txtFirstNumberValue.replace(/,/g, '');
        // console.log(secondNumber);
        ...
        if (!isNaN(result)) {
            document.getElementById('income0').value =  total;
