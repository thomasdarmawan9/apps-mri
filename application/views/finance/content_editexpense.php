<div class="card">
  <div class="card-header">
    <h3 class="card-title">Edit Expense Transaction</h3>
  </div>
  <div class="card-body">
    <?php foreach ($results as $r) { ?>
      <form method="post" action="<?= base_url('finance/accountant/submit_edit_expense'); ?>">
        ...
        <div class="row">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-12">
                <select class="form-control js-example-basic-multiple" name="id_indeks" id="id_indeks" required="" style="width: 100%">
                  <?php foreach ($indeks as $id) {
                      if ($id->id_indeks == $r->id_indeks) { ?>
                      <option value="<?php echo $id->id_indeks; ?>" selected><?php echo ucfirst($id->nama_indeks); ?></option>
                    <?php } else { ?>
                      <option value="<?php echo $id->id_indeks; ?>"><?php echo ucfirst($id->nama_indeks); ?></option>
                  <?php  }
                    } ?>
                </select>
              </div>
          ...
          <div class="col-md-6">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-12">
                <input name="jumlah" id="jumlah" class="form-control" onkeyup="cek_total();" value="<?php echo $r->jumlah; ?>" type="text" placeholder="Qty" required="" autocomplete="off">
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-12">
                <input name="harga" id="harga" class="form-control" onkeyup="cek_total();" value="<?php echo $r->harga; ?>" type="text" placeholder="Price" required="" autocomplete="off">
              </div>
            </div>
        ...
        <div class="modal-footer">
          ...
          <a href="<?= base_url('finance/accountant/expense') ?>"><button type="button" class="btn btn-blue-grey">Cancel</button></a>
        </div>
      </form>
    <?php } ?>
  </div>
