 	<div class="card">
 		...
 		<div class="card-body">
 		  <form action="../display/give_cuti_bulanan" method="post">
 			...
 			<button type="button" class="btn  teal" id="showcutitambah"><i class="fa fa-plus"></i> Cuti (IZIN)</button> 
 			<button type="button" class="btn  light-blue darken-2" id="showcuti"><i class="fa fa-minus"></i> Cuti (IZIN / SAKIT)</button> |
 			<?php if (date('Y-m-d') == date('Y-m-13')) { ?>
 					<button type="submit" class="btn black"><i class="fa fa-bolt"></i> Pencairan Cuti Izin dan Sakit</button>
 			<?php } ?>
 		  </form>
 			<hr>

 			<form method="post" action="<?= base_url('hr/overtime/tambah_lembur')?>" >
 			...
 			<form method="post" action="<?= base_url('hr/overtime/kurang_lembur')?>" >
 			...
 			<form method="post" action="<?= base_url('hr/overtime/kurang_cuti')?>" >
 			...
 			<form method="post" action="<?= base_url('hr/overtime/tambah_cuti')?>" >
