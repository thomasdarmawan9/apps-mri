<div class="card">
	<div class="card-header">
		<h3 class="card-title">Future Task Allocation</h3>
	</div>
	<div class="card-body">
		...
		<div class="modal-content">
			<form action="<?= base_url('support/task/submit') ?>" method="post" class="form-horizontal" style="width:100%">
				...
				<div class="modal-body">
					...
					<?php if($this->session->userdata('username') == 'taskadmin'){ ?>
					<div class="form-group row" id="divisi">
						<label class="col-form-label col-sm-4">Divisi</label>
						<div class="col-sm-8">
	...
	function edit(id) {
		...
		$.ajax({
			...
			success: function(result) {
				...
				if((location == 'Puri') || (location == 'BSD') || (location == 'KG') || (location == 'PH') || (location == 'Palem') || (location == 'BW') || (location == 'SBY')){
