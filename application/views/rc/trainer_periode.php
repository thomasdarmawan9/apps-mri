...
<div class="card">
	<div class="card-header">
		<h3 class="card-title">Regular Class Periode</h3>
	</div>
	<div class="card-body">
			...
			<table class="table table-bordered w-100" id="table1">
				...
				<tbody class="text-center">
					...
					foreach($periode as $row){
						...
						echo "<td><a class='btn btn-dark' href='".base_url('rc/trainer/periode/'.$row['periode_id'])."' title='Pilih' data-toggle='tooltip' data-placement='top'><i class='fa fa-play'></i> Pilih</a>";
...
<div class="card mt-3">
	<div class="card-header">
		<h3 class="card-title">Adult Class Periode</h3>
	</div>
	<div class="card-body">
		<div class="table-responsive">
			<table class="table table-bordered w-100" id="table2">
				...
				<tbody class="text-center">
					...
					foreach($periode_adult as $row){
						...
						echo "<td><a class='btn btn-dark' href='".base_url('rc/trainer/periode_adult/'.$row['periode_id'])."' title='Pilih' data-toggle='tooltip' data-placement='top'><i class='fa fa-play'></i> Pilih</a>";
