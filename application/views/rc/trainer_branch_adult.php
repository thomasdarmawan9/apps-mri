			...
			<table class="table table-bordered w-100" id="table1">
				...
				<tbody class="text-center">
					...
					foreach($branch as $row){
						...
						echo "<td><a class='btn btn-dark' href='".base_url('rc/trainer/branch_adult/'.$periode['periode_id'].'/'.$row['branch_id'])."' title='Pilih' data-toggle='tooltip' data-placement='top'><i class='fa fa-play'></i> Pilih</a>";
