...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="<?= base_url('rc/absensi/')?>"><?= $periode['periode_name']?></a></li>
        <li class="breadcrumb-item"><a href="<?= base_url('rc/absensi/')?>"><?= $class['branch_name']?></a></li>
        <li class="breadcrumb-item"><a
                href="<?= base_url('rc/absensi/periode/'.$periode['periode_id'].'/'.$class['branch_id'])?>"><?= $class['program']?></a>
        </li>
