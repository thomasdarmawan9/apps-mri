...
<div class="card">
	...
	<div class="card-body">
		<h4>FILTER DATA</h4>
		<br>
		<form method="post" action="<?= base_url('viewer/signup/batch')?>">
				...
				<tbody class="text-center">
					<?php 
						...
						foreach($list as $row){
							...
							echo "<td>
									<a class='btn btn-primary' href='".base_url('viewer/signup/batch_detail/'.$row['batch_id'])."' title='Manajemen Peserta' data-toggle='tooltip' data-placement='top'><i class='fa fa-list'></i></a>
								</td>";
							echo "</tr>";
						}
					?>
...
<div class="modal fade" tabindex="-1" id="modal_tambah" data-backdrop="static" data-keyboard="false">
	<div class="modal-dialog">
		<div class="modal-content">
			<form action="<?= base_url('viewer/signup/submit_form')?>" method="post" id="form_data" class="form-horizontal" style="width:100%">
...
<script>
	...
	function edit(id){
		...
		$.ajax({
			url: "<?= base_url('viewer/signup/json_get_batch_detail')?>",
			type: "POST",
			dataType: "json",
			data:{'id': id},
