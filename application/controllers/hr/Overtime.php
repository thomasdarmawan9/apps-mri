...
class Overtime extends CI_Controller {
	...
	public function _remap($method, $param = array()){
		if(method_exists($this, $method)){
			...
			if(!empty($level) && $level == 'hr' || $this->session->userdata('id') == '190' || $this->session->userdata('id') == '72'){
	...
	public function index(){
		...
		init_view('hr/content_lembur', $data);
	}

	public function acc(){
		$data['hsl'] = $this->model_lembur->get_acchr_lembur();
		set_active_menu('Acc Lembur');
		init_view('hr/content_acchrlembur', $data);
	}
	...
	public function acc_merch()
	{
		...
		init_view('hr/content_acchrmerch', $data);
	}
	...
	public function report_izin_hr(){
		...
		init_view('hr/content_laporanhrcuti', $data);
	}
	...
	public function report_sakit_hr(){
		...
		init_view('hr/content_laporancutiskt', $data);
	}
	...
	public function report_hr(){
		...
		init_view('hr/content_laporanhr', $data);
	}
	...
	public function detail_lembur($user, $tgl){
		...
		init_view('hr/content_detaillembur', $data);
	}
